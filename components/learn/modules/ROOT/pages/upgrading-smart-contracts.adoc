...
[WARNING.hardhat]
--
This guide and the Upgrades plugin haven't been migrated to Hardhat yet. The following content is for Buidler only. This will be changed shortly. Subscribe to https://github.com/OpenZeppelin/openzeppelin-upgrades/issues/206[OpenZeppelin/openzeppelin-upgrades#206] for updates.
--
