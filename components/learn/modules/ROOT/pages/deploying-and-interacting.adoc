...
[.hardhat]
--
In order to interact with the <<box-contract,`Box`>> contract we deployed, we'll use an https://docs.ethers.io/v6/api/contract/contract/[ethers contract instance].
