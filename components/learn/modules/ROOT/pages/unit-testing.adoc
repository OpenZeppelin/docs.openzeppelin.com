...
There is a a wide range of testing techniques, from xref:deploy-and-interact.adoc#interacting-from-the-terminal[simple manual verifications] to complex end-to-end setups, all of them useful in their own way.
