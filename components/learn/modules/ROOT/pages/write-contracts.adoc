 ...
 * For a general overview of how Ethereum and smart contracts work, you can't go wrong with Matt Condon's https://medium.com/@mattcondon/getting-up-to-speed-on-ethereum-63ed28821bbe[Getting Up to Speed on Ethereum]
