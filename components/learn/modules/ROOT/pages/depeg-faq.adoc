...
Another important point for us when implementing the 24-hour period was that we did not want to react too quickly in order not to trigger a Depeg case too0 hastily.
