...
[.card-learn]
--
xref:learn::writing-smart-contracts.adoc[[.title]#Write Smart Contracts# Write and compile your first Solidity contracts+++,+++ using the building blocks from the OpenZeppelin Contracts library.]
--

[.card-learn]
--
xref:learn::deploy-and-interact.adoc[[.title]#Local Development# Deploy your contracts to a local blockchain and send your first transactions using the OpenZeppelin CLI.]
--

[.card-learn]
--
xref:learn::unit-testing.adoc[[.title]#Test your Contracts# Unit test your contracts with the OpenZeppelin `test-environment`+++,+++ combined with assertions from our `test-helpers`.]
--

[.card-learn]
--
xref:learn::on-upgrades.adoc[[.title]#Upgrade your Contracts# Change the code of your deployed contracts to add new features or fix bugs+++,+++ using the OpenZeppelin CLI or the `upgrades` library.]
--

[.card-learn]
--
xref:learn::public-staging.adoc[[.title]#Deploy to Testnet# Set up a staging environment by deploying your app to a public Ethereum testnet using the OpenZeppelin CLI.]
--

[.card-learn]
--
xref:learn::on-dapps.adoc[[.title]#Build a Dapp# Create a decentralized web app using OpenZeppelin `network-js` and `hot-loader`+++,+++ or simply unpack a Starter Kit.]
--

[.card-learn]
--
xref:learn::on-gsn.adoc[[.title]#Send Gasless Transactions# Leverage the Gas Station Network so your users can send transactions without having ETH to pay for gas.]
--

[.card-learn]
--
xref:learn::mainnet.adoc[[.title]#Go to Mainnet# All the boxes you need to check before taking your project to production on the main Ethereum network.]
--
...
--
xref:#::index.adoc[[.title]#upgrades-js# A JavaScript library for managing upgradeable contracts+++,+++ which powers the OpenZeppelin CLI.]
--

[.card-generic.test-environment]
--
xref:test-environment::index.adoc[[.title]#test-environment# A JavaScript library for creating a testing environment for contracts+++,+++ which plays nice with Mocha+++,+++ Ava+++,+++ and Jest.]
--

[.card-generic.test-helpers]
--
xref:test-helpers::index.adoc[[.title]#test-helpers# A JavaScript library of common assertions for smart contracts+++,+++ which can be used with `test-environment`+++,+++ `truffle`+++,+++ or vanilla `web3-js` setups.]
--

[.card-generic.network-js]
--
xref:network-js::index.adoc[[.title]#network-js# A JavaScript library for easily connecting to the Ethereum network from a dapp+++,+++ used in most Starter Kits.]
--

[.card-generic.gsn-helpers]
--
xref:gsn-helpers::index.adoc[[.title]#gsn-helpers# A thin CLI and JavaScript library for simplifying development of an application using the Gas Station Network.]
--

[.card-generic.gsn-provider]
--
xref:gsn-provider::index.adoc[[.title]#gsn-provider# A `web3-js` provider for seamlessly sending gasless transactions via the Gas Station Network.]
--

[.card-generic.contract-loader]
--
xref:#::index.adoc[[.title]#hot-loader# A webpack plugin for automatically compiling and upgrading your contracts locally while you develop.]
--

[.card-generic.contract-loader]
--
xref:contract-loader::index.adoc[[.title]#contract-loader# A minimal JavaScript library for loading contract artifacts by name or ABI.]
--

[.card-generic.solidity-docgen]
--
xref:#::index.adoc[[.title]#solidity-docgen# A tool for automatically generating documentation based on the natspec comments of your Solidity contracts.]
--
