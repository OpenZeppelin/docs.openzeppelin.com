...
OpenZeppelin provides a complete suite of security products to adopt security best practices from the first line of code all the way to running your decentralized application onchain.
...
[.card.card-secondary.card-confidential]
--
xref:confidential-contracts::index.adoc[[.card-title]#Confidential Contracts# [.card-body]#pass:q[A library inspired by the vanilla contracts library built from the ground up for integration with confidential coprocessors.]#]
--
...
[.card.card-secondary.card-stellar-contracts]
--
xref:stellar-contracts::index.adoc[[.card-title]#Stellar Contracts# [.card-body]#pass:q[A library for secure smart contract development written in Rust for Stellar Soroban.]#]
--
