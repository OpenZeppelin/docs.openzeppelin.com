...
--
xref:defender::index.adoc[[.card-title]#Defender# [.card-body]#pass:q[A secure platform to code, audit, deploy, monitor, and operate your blockchain application.]#]
--

[.card.card-secondry.card-upgrades-js]
--
xref:upgrades.adoc[[.card-title]#Upgrades# [.card-body]#pass:q[A comprehensive suite of contracts and tooling to deploy and manage upgradeable smart contracts.]#]
--
