...
Explore our guides and examples to build decentralized insurance products using Etherisc and the Generic Insurance Framework (_GIF_).    
...
Etherisc is growing. If you enjoy using our products or reading our audit reports, and have a genuine interest in protecting the open economy, 
please check out our current https://openzeppelin.com/jobs/[job openings].

// TODO: Update Questions
== Questions?

Join the Etherisc community in https://forum.openzeppelin.com/[our forum] to https://forum.openzeppelin.com/c/support/17[ask for help], as well as share your feedback or showcase what you have built with OpenZeppelin!
