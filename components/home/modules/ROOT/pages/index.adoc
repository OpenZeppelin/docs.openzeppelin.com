...
[.card.card-learn]
--
xref:learn::index.adoc[[.card-title]#Environment Setup# [.card-body]#Install node+++,+++ npm+++,+++ and the basic libraries for web3 development.#]
--

[.card.card-learn]
--
xref:learn::writing-smart-contracts.adoc[[.card-title]#Write Smart Contracts# [.card-body]#Write and compile your first Solidity contracts+++,+++ using the building blocks from the OpenZeppelin Contracts library.#]
--

[.card.card-learn]
--
xref:learn::deploy-and-interact.adoc[[.card-title]#Local Development# [.card-body]#Deploy your contracts to a local blockchain and send your first transactions using the OpenZeppelin CLI.#]
--

[.card.card-learn]
--
xref:learn::unit-testing.adoc[[.card-title]#Test your Contracts# [.card-body]#Unit test your contracts with the OpenZeppelin `test-environment`+++,+++ combined with assertions from our `test-helpers`.#]
--

[.card.card-learn]
--
xref:learn::on-upgrades.adoc[[.card-title]#Upgrade your Contracts# [.card-body]#Change the code of your deployed contracts to add new features or fix bugs+++,+++ using the OpenZeppelin CLI or the `upgrades` library.#]
--

[.card.card-learn]
--
xref:learn::public-staging.adoc[[.card-title]#Deploy to Testnet# [.card-body]#Set up a staging environment by deploying your app to a public Ethereum testnet using the OpenZeppelin CLI.#]
--

[.card.card-learn]
--
xref:learn::on-dapps.adoc[[.card-title]#Build a Dapp# [.card-body]#Create a decentralized web app using OpenZeppelin `network-js` and `hot-loader`+++,+++ or simply unpack a Starter Kit.#]
--

[.card.card-learn]
--
xref:learn::on-gsn.adoc[[.card-title]#Send Gasless Transactions# [.card-body]#Leverage the Gas Station Network so your users can send transactions without having ETH to pay for gas.#]
--

[.card.card-learn]
--
xref:learn::mainnet.adoc[[.card-title]#Go to Mainnet# [.card-body]#All the boxes you need to check before taking your project to production on the main Ethereum network.#]
--
...
--
xref:#::index.adoc[[.card-title]#hot-loader# [.card-body]#A webpack plugin for automatically compiling and upgrading your contracts locally while you develop.#]
--
...
--
xref:#::index.adoc[[.card-title]#solidity-docgen# [.card-body]#A tool for automatically generating documentation based on the natspec comments of your Solidity contracts.#]
--
