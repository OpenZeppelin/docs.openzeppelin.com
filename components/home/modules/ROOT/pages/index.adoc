...
Build a Dapp:: Create a decentralized web app using OpenZeppelin Networks JS and Solidity Hot Loader, or simply unpack a Starter Kit
...
`solidity-loader`:: A webpack plugin for automatically compiling and upgrading your contracts locally while you develop
