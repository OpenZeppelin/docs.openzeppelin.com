;(function () {
  ...
  window.addEventListener('load', () => {
    setTimeout(() => {
      ...
      banner.innerHTML = `
        <div class="popup-banner-text popup-banner-new">Automate your Ethereum operations with OpenZeppelin Defender — <a href="https://openzeppelin.com/defender">Learn More</a></div>
